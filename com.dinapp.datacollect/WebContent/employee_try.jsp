			...
			<ul>
				...
				<fieldset class="marginleft">
					...
					<li id="frmEName" class="name notranslate name">
						<span>
							<label class="desc" id="Field1" for="Field1">Employee</label>
							<select id="select" class="field select fn" name="Field1"> 
								<option value=""></option>
						...
						<span>
							<br><input id="fldGF" name="fldGF" type="radio" class="field text" tabindex="7" onkeyup="handleInput(this);" onchange="handleInput(this);" />  F
						</span>					
						<span class="sep">
